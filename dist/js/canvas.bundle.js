...
/***/ "./node_modules/imports-loader/index.js?define=>false!./node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js":
/*!*********************************************************************************************************************************!*\
  !*** ./node_modules/imports-loader?define=>false!./node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js ***!
  \*********************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! imports-loader?define=>false!animation.gsap */ "./node_modules/imports-loader/index.js?define=>false!./node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js");

__webpack_require__(/*! imports-loader?define=>false!debug.addIndicators */ "./node_modules/imports-loader/index.js?define=>false!./node_modules/scrollmagic/scrollmagic/uncompressed/plugins/debug.addIndicators.js");
...
var controller = new ScrollMagic.Controller(); // Also works with TweenLite and TimelineLite

var mains = document.querySelectorAll(".main");
//console.log(mains);
//var self = this;

[].forEach.call(document.querySelectorAll(".main"), function (main) {
  var animateIn = new _gsap.TimelineMax();
  var overlay = main.querySelector(".overlay");
  var info = main.querySelector(".info");
  var infoTitle = main.querySelector(".info-title");
  var infoName = main.querySelector(".info-name");
  var infoLink = main.querySelector(".info-link");

  animateIn.fromTo(overlay, 3, { skewX: 30, scale: 1.5 }, {
    skewX: 0,
    xPercent: 120,
    transformOrigin: "0% 100%",
    ease: _gsap.Power4.easeOut
  }).from(info, 1, { scaleY: 0, transformOrigin: "bottom left", ease: _gsap.Power4.easeOut }, "-=1.5").from(infoTitle, 0.2, { autoAlpha: 0, y: 30, ease: _gsap.Power4.easeOut }, "-=1").from(infoName, 0.3, { autoAlpha: 0, y: 30, ease: _gsap.Power4.easeOut }, "-=.8").from(infoLink, 0.4, { autoAlpha: 0, y: 30, ease: _gsap.Power4.easeOut }, "-=.6");
